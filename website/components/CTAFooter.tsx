...
export function CTAFooter() {
  ...
  return (
    <>
      {/* CTA Section */}
      <section id="download" className="bg-[#0D3D28] py-20 px-4">
        <FadeIn className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="flex cursor-pointer items-center gap-3 rounded-xl bg-white px-6 py-3 font-medium text-[#0D3D28] transition-all duration-200 hover:bg-white/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 bg-[#0D3D28] px-4 py-8">
        <div className="mx-auto max-w-6xl">
          {/* Top row */}
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <Shield size={20} className="text-white" strokeWidth={1.75} />
              <span className="text-lg font-bold text-white">Khaznety</span>
            </div>
          ...
          <div className="mt-6 border-t border-white/10 pt-6 text-center">
            ...
            <p className="mt-2 text-xs text-white/30">
              &copy; {currentYear} Khaznety. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
